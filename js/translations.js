const translations = {
    pl: {
        ...
        sym_pots_list: "<li><strong>Nietolerancja ortostatyczna:</strong> Zawroty głowy i słabość przy staniu.</li><li><strong>Kołatania serca:</strong> Tachykardia bez wysiłku.</li><li><strong>Zaburzenia termoregulacji:</strong> Zimne dłonie/stopy, poty nocne.</li>",
    ...
    en: {
        ...
        sym_pots_title: "ME/CFS & Dysautonomia",
        sym_pots_list: "<li><strong>Orthostatic Intolerance:</strong> Dizziness and weakness when standing.</li><li><strong>Heart Palpitations:</strong> Tachycardia without exertion.</li><li><strong>Thermoregulation Issues:</strong> Cold hands/feet, night sweats.</li>",
