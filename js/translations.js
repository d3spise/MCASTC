const translations = {
    pl: {
        ...
        theory1_title: "Szlak Neurogenny (Bezpośredni)",
        ...
        theory2_step2: "Ucisk pnia mózgu wywołuje <strong>ME/CFS</strong>",
        theory2_step3: "Utrata kontroli (Dysautonomia) -> <strong>MCAS</strong>",
        theory2_concl: "Wniosek: Układ odpornościowy \"szaleje\", ponieważ uszkodzony Nerw Błędny (przez CCI/TC) przestał go hamować (brak Odruchu Przeciwzapalnego), a ME/CFS wprowadził chaos metaboliczny.",
        time_healthy: "~8h (Noc)",
        sev_mild: "Łagodny (~25%)",
    ...
    en: {
        ...
        theory1_title: "Neurogenic Pathway (Direct)",
        ...
        theory2_step2: "Brainstem compression triggers <strong>ME/CFS</strong>",
        theory2_step3: "Loss of control (Dysautonomia) -> <strong>MCAS</strong>",
        theory2_concl: "Conclusion: The immune system goes \"crazy\" because the damaged Vagus Nerve (by CCI/TC) stopped inhibiting it (lack of Anti-inflammatory Reflex), and ME/CFS introduced metabolic chaos.",
    }
};